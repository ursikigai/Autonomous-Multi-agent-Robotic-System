...
# class StatesDatasetEnv(gym.Env):    # auto-disabled
...
# quick smoke test
#     env = StatesDatasetEnv("../results/state_vectors", max_episode_len=50)    # auto-disabled
o, _ = env.reset()
...
# from stable_baselines3.common.vec_env import DummyVecEnv    # auto-disabled
from .env_from_states import StatesDatasetEnv

# def make_env():    # disabled make_env
#     return StatesDatasetEnv("../results/state_vectors", max_episode_len=200)    # auto-disabled

# env = DummyVecEnv([make_env])    # auto-disabled
